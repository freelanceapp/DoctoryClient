...
import com.doctory_client.databinding.ChatImageLeftRowBinding;
import com.doctory_client.databinding.ChatImageRightRowBinding;
import com.doctory_client.databinding.ChatMessageLeftRowBinding;
import com.doctory_client.databinding.ChatMessageRightRowBinding;
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        MessageModel messageModel = messageModelList.get(position);
            ...
            if (holder instanceof RightImageEventHolder) {
                ...
                com.doctory_client.adapters.Chat_Adapter.LoadMoreHolder loadMoreHolder = (com.doctory_client.adapters.Chat_Adapter.LoadMoreHolder) holder;
