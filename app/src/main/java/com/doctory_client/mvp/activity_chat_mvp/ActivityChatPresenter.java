                        ...
                        public void onResponse(Call<MessageModel> call, Response<MessageModel> response) {
                            ...
                            if (response.isSuccessful() && response.body() != null) {
                                ...
                                if (response.code() == 500) {
                                    ...
                                    // Toast.makeText(com.doctory_client.activities_fragments.chat_activity.ChatActivity.this, "Server Error", Toast.LENGTH_SHORT).show();

                                } else {
                                    view.onFailed(context.getResources().getString(R.string.failed));
                                    // Toast.makeText(com.doctory_client.activities_fragments.chat_activity.ChatActivity.this, getString(R.string.failed), Toast.LENGTH_SHORT).show();
                            ...
                            try {
                                if (t.getMessage() != null) {
                                    ...
                                    if (t.getMessage().toLowerCase().contains("failed to connect") || t.getMessage().toLowerCase().contains("unable to resolve host")) {
                                        ...
                                        //  Toast.makeText(com.doctory_client.activities_fragments.chat_activity.ChatActivity.this, R.string.something, Toast.LENGTH_SHORT).show();
                                    } else {
                                        view.onFailed(t.getMessage());
                                        //  Toast.makeText(com.doctory_client.activities_fragments.chat_activity.ChatActivity.this, t.getMessage(), Toast.LENGTH_SHORT).show();
                                    }
                                }
                ...
                .enqueue(new Callback<MessageDataModel>() {
                    ...
                    public void onFailure(Call<MessageDataModel> call, Throwable t) {
                        try {
                            ...
                            //  Toast.makeText(com.doctory_client.activities_fragments.chat_activity.ChatActivity.this, getString(R.string.something), Toast.LENGTH_SHORT).show();
